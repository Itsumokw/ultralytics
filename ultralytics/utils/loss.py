...
class v8DetectionLoss:
    ...
    def __init__(self, model, tal_topk=10, use_focal_loss=False):  # 新增 use_focal_loss 参数
        """初始化 v8DetectionLoss 类，定义模型相关属性和损失函数."""
    ...
    def __call__(self, preds, batch):
        ...
        # 分类损失
        loss[1] = self.cls_loss_fn(pred_scores, target_scores.to(dtype)).sum() / target_scores_sum  # 使用 FocalLoss 或 BCE
        ...
        return loss.sum() * batch_size, loss.detach()  # 返回总损失和各部分损失
